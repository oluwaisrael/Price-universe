...
const FILLER_STARS_PER_ARM = 1150
...
const INTERARM_DUST_POINTS_PER_GALAXY = 1400
...
const HALO_POINTS_PER_GALAXY = 500
  ...
  for (const site of Object.keys(GALAXY_CENTERS)) {
    ...
    for (let arm = 0; arm < VISUAL_ARM_COUNT; arm++) {
      ...
      for (let i = 0; i < FILLER_STARS_PER_ARM; i++) {
        ...
        const scatterAmount = ARM_SCATTER * (0.55 + 0.85 * radiusT) * (1 + coreBlend * 1.8)
