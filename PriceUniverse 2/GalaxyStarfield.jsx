...
function GalaxyStarfield() {
  ...
  const { armBuffers, armFineBuffers, hazeBuffers, coreDustBuffers, interarmBuffers, haloBuffers, ambientBuffers } = useMemo(() => {
    ...
    return {
      ...
      // whole galaxy.
      haloBuffers: buildBuffers(haloStars, (s) => 0.25 + s.scale * 0.25),
