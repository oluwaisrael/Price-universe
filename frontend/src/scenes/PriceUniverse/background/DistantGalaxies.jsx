...
export default function DistantGalaxies() {
  ...
  const galaxies = useMemo(
    () => [
      { pos: [-120, 55, -280], color: '#c8b0ff', scale: [14, 8], rot: 0.4, o: 0.28 },
      { pos: [140, 60, -300], color: '#a0d0ff', scale: [11, 6], rot: -0.6, o: 0.22 },
      { pos: [-160, -40, -290], color: '#ffc8a0', scale: [9, 5], rot: 0.9, o: 0.18 },
      { pos: [100, -55, -310], color: '#b0a0ff', scale: [12, 5.5], rot: -0.3, o: 0.2 },
      { pos: [20, 70, -320], color: '#90c0e8', scale: [7, 4], rot: 0.15, o: 0.16 },
      { pos: [-70, -65, -305], color: '#e0b090', scale: [8, 3.5], rot: -0.8, o: 0.14 },
    ],
    [],
  )
